...
from ...data.models.result.depth_result import DepthResult
from .models import DepthProEstimator
from ..registry import feature_registry

@feature_registry.register("depth")
class DepthFeature(BaseFeature):
    ...
    def process_frame(self, frame: VideoFramePacket, **inputs) -> DepthResult:
        """
    ...
    def process_batch(self, frames: List[VideoFramePacket], **inputs) -> List[DepthResult]:
        """
