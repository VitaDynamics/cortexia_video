...
class FrameField(Enum):
    ...
    GATE_RESULTS_PASSES = "gate_results.passes"
    GATE_RESULTS_GATE_DECISIONS = "gate_results.gate_decisions"
    GATE_RESULTS_GATE_SCORES = "gate_results.gate_scores"
    GATE_RESULTS_GATE_METADATA = "gate_results.gate_metadata"
...
class FieldValidator:
    ...
    def get_field_summary(frame: 'VideoFramePacket') -> Dict[str, Any]:
        ...
        summary = {
            ...
            "derived_metadata_keys": list(frame.derived_metadata.keys()) if frame.derived_metadata else []
        }
