...
from cortexia_video.features.listing.models import OBJECT_LISTER_REGISTRY
from cortexia_video.features.caption.models import IMAGE_CAPTIONER_REGISTRY
...
class ConfigManager:
    ...
    def get_feature_extractor(self) -> Optional[Any]:
        ...
        try:
            ...
            from cortexia_video.features.feature_extraction.models import (
